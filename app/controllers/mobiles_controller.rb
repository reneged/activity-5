class MobilesController < ApplicationController
  ...
  def decrement_stock
      ...
      @mobile.save
      redirect_to "http://localhost:3000/mobiles"
  end
  ...
  private
    ...
    def mobile_params
      params.require(:mobile).permit(:name, :brand, :year_released, :camera, :mpixel, :internalstorage, :simslots, :screen_size, :os, :stock_num)
    end
end
